set background=dark
highlight clear
let g:colors_name="acretercolor"
...
hi Normal       guifg=#ffe6b3       guibg=#131313       gui=NONE
...
hi NonText      guifg=#F2EB2B       guibg=NONE          gui=bold
            \   ctermfg=yellow      ctermbg=NONE        cterm=NONE
hi Whitespace   guifg=#4b4b4b       guibg=NONE          gui=NONE
            \   ctermfg=yellow      ctermbg=NONE        cterm=NONE
...
hi ColorColumn  guifg=NONE          guibg=#1b1b1b       gui=NONE
            \   ctermfg=NONE        ctermbg=gray        cterm=NONE
...
hi Search       guifg=NONE          guibg=#333333       gui=NONE
            \   ctermfg=NONE        ctermbg=darkgreen   cterm=NONE
